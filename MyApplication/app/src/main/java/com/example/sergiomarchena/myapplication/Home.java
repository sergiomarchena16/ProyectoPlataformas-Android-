...
import com.example.sergiomarchena.myapplication.Model.Category;
import com.example.sergiomarchena.myapplication.ViewHolder.MenuViewHolder;
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                viewHolder.setItemOnClickListener(new ItemOnClickListener() {
                    ...
                    public void OnClick(View view, int position, boolean isLongClick) {
                        ...
                        //GetCategoryId and send to new Activity
